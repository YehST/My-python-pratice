# coding: utf-8
from ReferenceData.common.trainer import Trainer
from ReferenceData.common.util import shuffle_dataset
...
for _ in range(optimization_trial):
    # 探索したハイパーパラメータの範囲を指定===============
    weight_decay = 10 ** np.random.uniform(-8, -7)  # first(-8, -4)
    lr = 10 ** np.random.uniform(-3, -2)  # first(-6, -2)
    # ================================================
